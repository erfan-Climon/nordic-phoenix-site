 ...
 * first paint — laddas därför vid idle (eller efter 2,5 s som fallback).
 * Widgeten placerar sig själv nere till höger; därav bottom:96px på den egna
 * flytande widgeten så att de inte krockar.
 */
